...
public class Test_Steps_Add_Answer {
	...
	public void the_answer_of_is_shown_in_the_page(String answer, String person) throws Throwable {
		WebElement actualPerson = driver.findElement(By.className("post-person"));
		WebElement actualAnswer = driver.findElement(By.className("post-text"));
		Assert.assertEquals("Answered by: "+ person, actualPerson.getText().toString());
		Assert.assertEquals(answer, actualAnswer.getText());
	}
	...
	public void no_answer_is_shown_in_the_page() throws Throwable {
	    java.util.List<WebElement> elements = driver.findElement(By.className("anwers-list")).findElements(By.className("anwers-item"));
